...
export default function Home() {
    ...
    const handleGenericAction = (title: string, idToToggle?: string) => {
     ...
     const handleAgentAction = (title: string, idToToggle: string, agentName: string, payload: any = {}) => {
         // Placeholder for triggering agent actions via Coordinator
         toast({ title: title, description: `TODO: Call Agent Coordinator for '${agentName}'.` });
         toggleWindowVisibility(idToToggle); // Close the prompt window
         // Example call:
         // fetch(`/api/proxy/agents/${agentName}/execute`, { method: 'POST', ..., body: JSON.stringify(payload) })
     };
                ...
                {Object.values(windowStates)
                  ...
                  .map((state) => {
                    // Define props common to all windows
                     const windowProps = {
                         key: state.id, // Use the window ID as the key
                    ...
                    // Add more complex windows here
                     switch (state.id) {
                        ...
                        case 'explainCode': // Specific window for Explain Code
                            return <RetroWindow {...windowProps} className="w-[450px] h-auto" initialPosition={{ top: '28%', left: '52%' }}>
                                <div className="p-2 flex flex-col gap-2">
                        ...
                        case 'security':
                         ...
                         case 'about':
                             return <RetroWindow {...windowProps} className="w-[400px] h-[300px]" initialPosition={{ top: '45%', left: '30%' }}>
                                 <div className="p-2 text-sm">
                                     ...
                                     <p className="mt-1">Version: 0.6.0 (AI Enhanced)</p>
                         ...
                         default:
                            ...
                            return <RetroWindow {...windowProps} className="w-64 h-48" initialPosition={{ top: '50%', left: '50%' }}>
